...
vagrant ssh master <<EOF
    ...
    sshpass -p "baye7" sudo -u altschool mkdir -p /mnt/altschool/slave
    sshpass -p "baye7" sudo -u altschool scp -r /mnt/* vagrant@192.168.56.11:/home/vagrant/mnt
